...
class EnergyAudioEffect(AudioReactiveEffect, Effect1D):
    ...
    CONFIG_SCHEMA = vol.Schema({
        ...
        vol.Optional('color_cycler', description='Change colors in time with the beat', default = False): bool,
        ...
        vol.Optional('sensitivity', description='Responsiveness to changes in sound', default = 0.85): vol.All(vol.Coerce(float), vol.Range(min=0.3, max=0.99)),
